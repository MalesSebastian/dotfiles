...
" C Indent
autocmd FileType c setlocal shiftwidth=2 tabstop=2 softtabstop=0 expandtab
" C++ Indent
autocmd FileType cpp setlocal shiftwidth=2 tabstop=2 softtabstop=0 expandtab
